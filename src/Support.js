...
export default class Support {
	...
	log(str, tabNo = '') {
		...
		if (isMainThread) {
			data += 'ThreadType: Master Thread LogMessage: ' + str;
			console.log(data);
		} else {
			data += 'ThreadId: ' + workerData.threadId + ' on TabNo: ' + tabNo + ' ThreadType: Child Thread LogMessage: ' + str;
			console.log(data);
		}
	}
	...
	error(str, tabNo = '') {
		...
		let data = new Date().toString() + ' ';
		if (isMainThread) {
			data += 'ThreadType: Master Thread ERROR: ' + str;
			console.log(data);
		} else {
			data += 'ThreadId: ' + workerData.threadId + ' on TabNo: ' + tabNo + ' ThreadType: Child Thread ERROR: ' + str;
			console.log(data);
		}
	}
